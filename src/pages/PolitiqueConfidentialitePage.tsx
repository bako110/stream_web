...
Recours : si vous estimez que vos droits ne sont pas respectés, vous pouvez saisir la CNIL sur www.cnil.fr`,
  },
  {
    ...
    body: `FoliX met en œuvre un ensemble de mesures techniques et organisationnelles pour protéger vos données :
...
• Les utilisateurs concernés seront notifiés dans les meilleurs délais si la violation présente un risque élevé`,
  },
  {
    ...
    body: `FoliX utilise des technologies similaires aux cookies que nous classons en trois catégories :
...
Nous ne collectons pas sciemment de données personnelles d'enfants de moins de 13 ans. Si vous êtes un parent ou tuteur légal et pensez qu'un enfant de moins de 13 ans a créé un compte sur FoliX, contactez-nous immédiatement à privacy@folix.app.`,
  },
  {
        ...
        <div className="rounded-2xl p-6 flex flex-col sm:flex-row gap-5 items-start"
          ...
          <div className="flex-1">
            <h2 className="text-xl font-black mb-1" style={{ color: 'var(--text-primary)' }}>
              Confidentialité FoliX
            </h2>
            <p className="text-sm mb-3" style={{ color: 'var(--text-tertiary)' }}>FoliX SAS · Paris, France · DPO : privacy@folix.app</p>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 min-w-0 space-y-4">
            ...
            <div className="rounded-2xl p-4 flex items-start gap-3"
              ...
              <div>
                ...
                <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>
                  ...
                  <a href="mailto:privacy@folix.app" className="font-semibold" style={{ color: accent }}>
                    privacy@folix.app
                  </a>
            ...
            <p className="text-center text-xs py-2" style={{ color: 'var(--text-tertiary)' }}>
              Politique de confidentialité v2.0 · FoliX SAS · © 2026 Sahelys · Tous droits réservés
            </p>
          </div>
        </div>
      </div>
