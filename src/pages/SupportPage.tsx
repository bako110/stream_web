        ...
        {loading ? (
          ...
          <>
            ...
            <div className="flex justify-start mb-4">
              <div className="max-w-[80%] sm:max-w-[420px] rounded-2xl rounded-bl-sm px-4 py-3"
            ...
            {messages.map(msg => {
              ...
              return (
                <div key={msg.id} className={`flex ${isStaff ? 'justify-start' : 'justify-end'}`}>
                  <div className={`max-w-[80%] sm:max-w-[420px] rounded-2xl px-4 py-3 ${isStaff ? 'rounded-bl-sm' : 'rounded-br-sm'}`}
                    style={isStaff
