...
export default function SettingsVerificationPage() {
  ...
  const renderStatus = () => {
    const CFG = {
      ...
      approved: { icon: <CheckCircle size={48} color={BLUE} />, color: BLUE, title: 'Compte vérifié', sub: 'Votre compte est certifié FoliX.' },
  ...
  const renderStep0 = () => (
    <div className="space-y-4">
      <div className="rounded-2xl p-5 flex flex-col items-center gap-3 text-center"
        ...
        <p className="font-black text-lg" style={{ color: 'var(--text-primary)' }}>Badge vérifié FoliX</p>
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 sm:p-6 space-y-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-black" style={{ color: 'var(--text-primary)' }}>Vérification FoliX</h1>
