      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-2 gap-2.5">
            <div className="rounded-2xl p-3 flex flex-col items-center gap-1" style={{ background: 'var(--surface)', border: '1px solid var(--border)' }}>
              <Users size={16} color="#3B82F6" />
              <p className="text-[17px] font-black" style={{ color: 'var(--text-primary)' }}>{fmtNum(overview.unique_viewers)}</p>
              <p className="text-[11px] font-semibold text-center" style={{ color: 'var(--text-tertiary)' }}>Spectateurs uniques</p>
            </div>
            <div className="rounded-2xl p-3 flex flex-col items-center gap-1" style={{ background: 'var(--surface)', border: '1px solid var(--border)' }}>
              <Globe size={16} color="#10B981" />
              <p className="text-[17px] font-black" style={{ color: 'var(--text-primary)' }}>{overview.top_countries.length}</p>
              <p className="text-[11px] font-semibold text-center" style={{ color: 'var(--text-tertiary)' }}>Pays touchés</p>
            </div>
          </div>
          ...
          <div className="rounded-2xl p-4" style={{ background: 'var(--surface)', border: '1px solid var(--border)' }}>
            ...
            <TimeSeriesChart data={overview.timeseries} granularity={overview.granularity} color="var(--primary)" width={560} />
          </div>
          ...
          <div className="flex items-center justify-between pt-1">
            <p className="text-[15px] font-black" style={{ color: 'var(--text-primary)' }}>Tous les contenus</p>
          ...
          {contentItems.length === 0 ? (
            <p className="text-[13px] text-center py-3" style={{ color: 'var(--text-tertiary)' }}>
